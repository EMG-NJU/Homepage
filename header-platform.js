        ...
        '<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">' +
          ...
          '<tr>' +
            ...
            '<td valign="baseline" bgcolor="#B1040E" style="text-align: left; font-size: 24px; font-family: Georgia, \'Times New Roman\', Times, serif; color: #FFFFFF;">' +
              '<p><strong>南京大学工程医学研究组</strong> (EMG@NJU)</p>' +
      ...
      '<div>' +
        '<table width="100%" border="0" cellpadding="0" cellspacing="0">' +
          ...
          '<tr>' +
            ...
            '<td width="20%" bgcolor="#F2F1EB" style="text-align: center"><strong><style="font-size: 24px">设备介绍</a></strong></td>' +
            '<td width="20%" bgcolor="#F2F1EB" style="text-align: center"><strong><style="font-size: 24px">培训通知</a></strong></td>' +
